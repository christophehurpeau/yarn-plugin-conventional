...
const SUPPORTED_UPGRADE_REGEXP =
  // eslint-disable-next-line unicorn/no-unsafe-regex, unicorn/better-regex -- note that autofix cause issues https://github.com/sindresorhus/eslint-plugin-unicorn/issues/1626
